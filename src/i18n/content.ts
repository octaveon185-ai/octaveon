...
export const content = {
  en: {
    ...
    event: {
      ...
      dressCode: 'Dress with intention. Elegant, artistic, and uniquely you.',
    ...
    gallery: {
      eyebrow: 'THE SETTING',
      title: 'WHERE IT ALL COMES ALIVE.',
      tiles: [
        'The venue, ready to receive',
        'An afternoon on the terrace',
        'Botanical food for sharing',
        'A table made for gathering',
        'Sound in the room',
        'Live musicians, close up',
        'Light becomes atmosphere',
        'A room full of movement',
      ],
      alts: [
        'Altea venue and mountain landscape',
        'Sunlit terrace ready for a gathering in Altea',
        'Colourful botanical food and flowers prepared for guests',
        'Abundant shared table with natural food and flowers',
        'DJ performing beneath immersive blue projections',
        'Live saxophone performance in an intimate room',
        'Living visual installation transforming the event space',
        'A crowd gathered beneath vivid projections and music',
      ],
    ...
    invite: {
      ...
      details: '€80 per person · all included · dress with intention.',
      fields: {
        name: 'Name',
        emailLabel: 'Email',
  ...
  it: {
    ...
    event: {
      ...
      priceLabel: 'QUOTA',
      price: '€80 · TUTTO INCLUSO',
      dressCodeLabel: 'DRESS CODE',
      dressCode: 'Vesti con intenzione. Elegante, artistico e autenticamente tuo.',
    ...
    gallery: {
      eyebrow: 'IL LUOGO',
      title: 'DOVE TUTTO PRENDE VITA.',
      tiles: [
        'Il luogo, pronto ad accogliere',
        'Un pomeriggio in terrazza',
        'Cibo botanico da condividere',
        'Una tavola per stare insieme',
        'Il suono prende forma',
        'Musicisti dal vivo, da vicino',
        'La luce diventa atmosfera',
        'Una sala piena di movimento',
      ],
      alts: [
        'Luogo dell’evento ad Altea con vista sulle montagne',
        'Terrazza assolata pronta ad accogliere un incontro ad Altea',
        'Cibo botanico colorato e fiori preparati per gli ospiti',
        'Tavola condivisa con cibo naturale e fiori',
        'DJ in performance sotto proiezioni blu immersive',
        'Performance di sassofono dal vivo in una sala raccolta',
        'Installazione visiva che trasforma lo spazio dell’evento',
        'Pubblico riunito tra proiezioni e musica',
      ],
    ...
    invite: {
      ...
      details: '€80 a persona · tutto incluso · vesti con intenzione.',
      fields: {
        name: 'Nome',
        emailLabel: 'Email',
  ...
  es: {
    ...
    event: {
      ...
      priceLabel: 'APORTACIÓN',
      price: '80 € · TODO INCLUIDO',
      dressCodeLabel: 'CÓDIGO DE VESTIMENTA',
      dressCode: 'Vístete con intención. Elegante, artístico y genuinamente tú.',
    ...
    gallery: {
      eyebrow: 'EL LUGAR',
      title: 'DONDE TODO COBRA VIDA.',
      tiles: [
        'El espacio, listo para recibir',
        'Una tarde en la terraza',
        'Comida botánica para compartir',
        'Una mesa para encontrarnos',
        'El sonido toma la sala',
        'Músicos en directo, de cerca',
        'La luz se vuelve atmósfera',
        'Una sala llena de movimiento',
      ],
      alts: [
        'Espacio del evento en Altea con vistas a la montaña',
        'Terraza soleada preparada para un encuentro en Altea',
        'Comida botánica colorida y flores preparadas para los invitados',
        'Mesa compartida con comida natural y flores',
        'DJ actuando bajo proyecciones azules inmersivas',
        'Saxofón en directo en una sala íntima',
        'Instalación visual que transforma el espacio del evento',
        'Público reunido entre proyecciones y música',
      ],
    ...
    invite: {
      ...
      details: '80 € por persona · todo incluido · vístete con intención.',
      fields: {
        name: 'Nombre',
